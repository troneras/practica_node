...
// custom errors
module.exports = function CustomError(status,msg,res){
    ...
    if(typeof msg !== 'string'){
        ...
        if(msg.errors){
            ...
            return {success: false, code:status, errors: {message : mensaje, errors: errors}};
        }
    }
    // Si el error es un string lo devolvemos traducido
    return {success:false, code:status, errors: res.__(msg)};
};
